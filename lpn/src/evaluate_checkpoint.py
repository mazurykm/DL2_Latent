...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=False,
        default="mean",
        help="Inference mode to use, choose from ['mean', 'first', 'random_search', 'gradient_ascent', 'cross_attention'].",
    )
    parser.add_argument(
        "--random-search-seed",
        type=int,
    ...
    if args.inference_mode not in ["mean", "first", "random_search", "gradient_ascent", "cross_attention"]:
        parser.error(
            "Invalid inference mode. Choose from ['mean', 'first', 'random_search', 'gradient_ascent', 'cross_attention']."
        )
